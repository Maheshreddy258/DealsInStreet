...
import com.deals.sine90.dealsinstreet.ExclusiveStoreList;
...
public class ExclusiveAdapter extends BaseAdapter {
    ...
    public ExclusiveAdapter(Activity activity, List<Listview> listitems) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.exclusivemodel, null);
        ...
        direction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(activity, ExclusiveStoreList.class);
