...
public class CustomListAdapter extends BaseAdapter {
    ...
    public CustomListAdapter(Activity activity, List<Listview> listitems) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.server_list, null);
      ...
      final TextView   like=(TextView)convertView.findViewById(R.id.liketext);
        ...
        direction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("longnitude",m.getLongnitude());
                activity.startActivity(intent);
            }
        });
